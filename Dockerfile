...
COPY --from=builder --chown=webuser:home /identity/server /home/webuser/server
COPY --from=builder --chown=webuser:home /identity/migrations /home/webuser/migrations
